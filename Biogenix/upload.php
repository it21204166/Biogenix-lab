...
if (isset($_POST['upload'])) { // If isset upload button or not
	...
	*/
	...
	if ($file_size > 10485760) { // Check file size 10mb or not
		echo "<script>alert('File is too big. Maximum file size allowed for upload 10 MB.')</script>";
	} else {
		...
		if ($result) {
			...
			echo "<script>alert('Something wong went.')</script>";
		}
	}
}
...
<head>
	...
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">//https://getbootstrap.com/

	<link rel="stylesheet" type="text/css" href="up_down.css">
